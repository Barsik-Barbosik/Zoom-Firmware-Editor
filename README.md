...
If you dont have Java Installed, you can download and run "ZoomFirmwareEditor-setup.exe". That setup application will install the compiled Windows executable with embedded JWM (created using Excelsior JET).
